...
**Milestone**: M7.5 → **M8.1** (Ingredient Parsing Intelligence - Phase 1)
**Status**: ⏳ PLANNED
**Version**: 1.1
**Created**: December 19, 2025
**Updated**: January 4, 2026 (Renumbered as M8.1 in new milestone structure)
**Dependencies**: M7.4 complete (Sync Status UI)

> **NOTE**: This PRD's content is now **M8.1: Parsing Resilience & Telemetry** in the new milestone structure. See [M8 Meta-PRD](../m8-ingredient-parsing-intelligence-meta-prd.md) for the complete 4-phase parsing intelligence roadmap (M8.1-M8.4).
