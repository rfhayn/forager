...
**Milestone**: M8.0 → **M8.2 + M8.3** (Ingredient Parsing Intelligence - Phases 2-3)
**Status**: ⏳ PLANNED
**Version**: 1.1
**Created**: December 19, 2025
**Updated**: January 4, 2026 (Renumbered as M8.2 + M8.3 in new milestone structure)
**Dependencies**: M7 complete (telemetry data from external beta)

> **NOTE**: This PRD's content is now split into **M8.2: Telemetry Analysis & Strategy** (Phase 1 of this document) and **M8.3: Hybrid NLP Parser** (Phases 2-4 of this document) in the new milestone structure. See [M8 Meta-PRD](../m8-ingredient-parsing-intelligence-meta-prd.md) for the complete 4-phase parsing intelligence roadmap (M8.1-M8.4).
